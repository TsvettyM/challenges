...
const RandomQuoteBox = () => {
  ...
  return (
    <div className="random__quote flex flex-col relative justify-center items-center w-full max-w-[450px] shadow-xl rounded-md p-6 border border-black/5">
      ...
      <hr className="border-[#354AA4] w-full my-2 border-t-1" />
