...
const HomepageMultiSelectSearch = () => {
  ...
  return (
    <section className="homepage__multiselect--search flex justify-center items-center py-40 w-full bg-[#EDEFFB] h-full">
      <div className="container">
        <div className="multi__select relative w-full sm:max-w-[500px]">
          <div
            className="w-full flex items-center gap-2 3
            h-12 bg-white border border-black rounded-md p-3 text-left"
            onClick={handleOpen}
          >
